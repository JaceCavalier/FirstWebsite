(function (window) {
    ...
    platform.init = function (game) {
        ...
        // example:
        platform.create(800, 600, .5);
        platform.create(450, 520, .5);
        platform.create(230, 420, .5);
        platform.create(600, 350, .5);
        platform.create(230, 280, .5);
        platform.create(600, 200, .5);
